...
1.  [Wikipedia article on InfiniBand](http://en.wikipedia.org/wiki/InfiniBand)
2.  [InfiniBand Trade Association (IBTA) website](http://www.infinibandta.org/)
3.  [Quick Start Guide:Environment Modules](Quick_Start_Guide:Environment_Modules "wikilink")
4.  [OpenMPI FAQ: TCP auto-disable](http://www.open-mpi.org/faq/?category=tcp#tcp-auto-disable)
